# =================================================================================
# 13. комплексный аудит реестра.ps1 — Расширенный скрипт комплексного аудита реестра
# PowerShell >= 5.1
# Автор: hypo69
# Версия: 0.1.0
...
<#
.SYNOPSIS
    Выполняет более детальный аудит реестра Windows, включая автозагрузку, настройки безопасности, информацию о системе, сетевые настройки и историю USB-устройств.
...
.EXAMPLE
    PS C:\> .\13. комплексный аудит реестра.ps1
    # Запускает расширенный скрипт комплексного аудита реестра.
#>
