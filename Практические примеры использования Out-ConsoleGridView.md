...
Это одна из самых частых задач: "Какая программа тормозит интернет?" или "Кто и куда отправляет данные?". С помощью `Out-ConsoleGridView` можно получить наглядный и интерактивный ответ.
...
*   Это отличный способ быстро выявить программы, которые работают в фоне и используют сеть без вашего ведома.
